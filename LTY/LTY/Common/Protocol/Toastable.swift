...
public class SFToast: Toastable {
    ...
    static public func showMessage(_ message: String?, duration: TimeInterval = 2, position: ToastPosition = .center, title: String? = nil, image: UIImage? = nil, style: ToastStyle = ToastManager.shared.style, completion: ((_ didTap: Bool) -> Void)? = nil) {
    ...
    static public func hideAllToasts(includeActivity: Bool = false, clearQueue: Bool = true) {
